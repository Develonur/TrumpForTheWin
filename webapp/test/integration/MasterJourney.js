sap.ui.define([
		...
		opaTest("MasterList Filtering on longitude less than 100", function(Given, When, Then) {

			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog("<longitude>").
				and.iSelectListItemInViewSettingsDialog("<100 <latitude>").
		...
		opaTest("MasterList Filtering on longitude more than 100", function(Given, When, Then) {
			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog(">100 <latitude>").
				and.iPressOKInViewSelectionDialog();
