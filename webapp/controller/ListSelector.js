sap.ui.define([
		...
		return BaseObject.extend("be.ehb.tftw.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias be.ehb.tftw.model.ListSelector
			 */
			 ...
			 * @return {be.ehb.tftw.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
