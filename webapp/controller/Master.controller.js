/*global history */
sap.ui.define([
		"be/ehb/tftw/controller/BaseController",
		...
		"sap/ui/Device",
		"be/ehb/tftw/model/formatter",
		"be/ehb/tftw/model/grouper",
		...
		return BaseController.extend("be.ehb.tftw.controller.Master", {
			...
			onSearch : function (oEvent) {
				...
				if (sQuery) {
					this._oListFilterState.aSearch = [new Filter("messageType", FilterOperator.Contains, sQuery)];
				} else {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("be.ehb.tftw.view.ViewSettingsDialog", this);
			...
			onConfirmViewSettingsDialog : function (oEvent) {
				...
				aFilterItems.forEach(function (oItem) {
					switch (oItem.getKey()) {
						case "Filter1" :
							aFilters.push(new Filter("longitude", FilterOperator.LE, 100));
							break;
						case "Filter2" :
							aFilters.push(new Filter("longitude", FilterOperator.GT, 100));
							break;
						default :
							break;
					}
			...
			_onMasterMatched :  function() {
				this.getOwnerComponent().oListSelector.oWhenListLoadingIsDone.then(
					function (mParams) {
						...
						var sObjectId = mParams.firstListitem.getBindingContext().getProperty("messageType");
			...
			_showDetail : function (oItem) {
				...
				this.getRouter().navTo("object", {
					objectId : oItem.getBindingContext().getProperty("messageType")
				}, bReplace);
			},
